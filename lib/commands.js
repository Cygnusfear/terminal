...
var help = (exports.help = {
    exec: function exec(state) {
        ...
        return Object.assign({}, state, {
            history: (_state$history = state.history).concat.apply(
                _state$history,
                [
                    { value: "React-bash:" },
                    {
                    ...
                    _toConsumableArray(
                        helpCommands.map(function(value) {
                            return { value: value };
                        }),
                    ),
                ),
...
var ls = (exports.ls = {
    exec: function exec(state, _ref) {
        ...
        var _Util$getDirectoryByP = Util.getDirectoryByPath(
                state.structure,
                fullPath,
            ),
...
var cat = (exports.cat = {
    exec: function exec(state, _ref2) {
        ...
        var _Util$getDirectoryByP2 = Util.getDirectoryByPath(
                state.structure,
                fullPath,
            ),
...
var mkdir = (exports.mkdir = {
    exec: function exec(state, _ref3) {
        ...
        var _Util$getDirectoryByP3 = Util.getDirectoryByPath(
                deepCopy,
                fullPath,
            ),
...
var cd = (exports.cd = {
    exec: function exec(state, _ref4) {
        ...
        var _Util$getDirectoryByP4 = Util.getDirectoryByPath(
                state.structure,
                fullPath,
            ),
...
var rm = (exports.rm = {
    exec: function exec(state, _ref6) {
        ...
        var _Util$getDirectoryByP5 = Util.getDirectoryByPath(
                deepCopy,
                fullPath,
            ),
